...
def run():
    ...
    # X_trainval, X_test, y_trainval, y_test = train_test_split(X, Y, test_size=0.3, stratify=Y,
    #                                                           random_state=69)  # Split train into train-val
    #
    # X_train, X_val, y_train, y_val = train_test_split(X_trainval, y_trainval, test_size=0.34, stratify=y_trainval,
    #                                                   random_state=21)
    #
    ...
    if args.method == "XGB":
        ...
        scheduler = torch.optim.lr_scheduler.StepLR(optimizer, step_size=200, gamma=1)
